...
public class SetUserName : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        userName = GameObject.Find("UserNameButton").GetComponent<Text>();
        buttonReset = GameObject.Find("FullReset").GetComponent<FullReset>();
    ...
    void Update()
    {
        ...
        {
            if(VirtualKeyboard0.OutputText == "")
            {
                userName.text = "Type Name!";
            }
            else
            {
                userName.text = VirtualKeyboard0.OutputText;
                buttonReset.Clear_All();
            }
